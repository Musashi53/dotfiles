...
return function(s)
	...
	local sep = wibox.widget.textbox("<span color='" .. beautiful.foreground .. "'> | </span>") -- separator widget
	sep.font = beautiful.font .. " Bold 14"

	local date = wibox.widget({
		widget = wibox.widget.textclock,
		format = "<span color='" .. beautiful.green .. "'>%B %d, %Y</span>",
		align = "center",
		valign = "center",
	...
	local time = wibox.widget({
		widget = wibox.widget.textclock,
		format = "<span color='" .. beautiful.green .. "'>%I:%M %P</span>",
		align = "center",
		valign = "center",
		font = beautiful.font .. " Bold 14",
	})
	...
	s.taglist = awful.widget.taglist({
		...
		widget_template = {
			...
			create_callback = function(self, c3, _)
				...
				if c3.selected then
					self.widget.children[1].bg = beautiful.green
